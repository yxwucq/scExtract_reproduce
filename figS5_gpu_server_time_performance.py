...
def run_performance_experiment(
    ...
    api_key,
    azure_endpoint,
    n_copies=21  # Number of times to duplicate datasets
):
    """
    ...
    for i in range(0, n_copies, 3):
        ...
        #     embedding_dict = {key: np.ones(50) for key in input_list}
...
if __name__ == "__main__":
    results = run_performance_experiment(
        input_path='/home/tangfuchou_pkuhpc/tangfuchou_coe/tangfuchou_coe/wuyuxuan/dat/AutoExtract/pancrea_time_test/pancreas.h5ad',
        output_dir='/home/tangfuchou_pkuhpc/tangfuchou_coe/tangfuchou_coe/wuyuxuan/dat/AutoExtract/pancrea_time_test',
        api_key=None,
